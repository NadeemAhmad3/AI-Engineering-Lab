...
def train_and_save_model(model_path: str = MODEL_PATH):
    """Trains a Random Forest classifier model for Day 4 async vs blocking benchmarks."""
    os.makedirs(os.path.dirname(model_path), exist_ok=True)
    
    print("Training Random Forest model for Day 4 experiment...")
...
class ModelManager:
    """Singleton model container for in-memory model access."""
    _model = None
